...
La tienda de música necesita un sistema de gestión que le permita organizar y administrar de manera eficiente la
información relacionada con sus socios, álbumes, copias, distribuidoras y préstamos. Actualmente, el manejo de datos se realiza de forma manual, lo que genera problemas como pérdida de información, duplicación de registros, dificultad para realizar consultas rápidas y falta de control en los préstamos y devoluciones.
Cada préstamo está asociado a una copia y a un socio, dentro del préstamo se ingresa la copia que equivale a un día de préstamo. En caso de que el socio entregue tarde la copia, por cada día extra se aplica el precio por día más un 20%.
También deberá ser creada una cuenta para los socios y una para los administradores con sus respectivas contraseñas.
